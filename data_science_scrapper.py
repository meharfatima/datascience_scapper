# -*- coding: utf-8 -*-
"""
Created on Thu Jan  7 14:46:59 2021
...
def get_jobs(keyword, num_jobs, verbose, path):
    ...
    url = 'https://www.glassdoor.com/Job/jobs.htm?sc.keyword='+keyword+'&suggestCount=0&suggestChosen=false&clickSource=searchBox'
    driver.get(url)
    jobs = []
